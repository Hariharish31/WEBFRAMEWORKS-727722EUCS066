...
public class HarishChildren {
     ...
     public HarishChildren() {

     }

     public HarishChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
