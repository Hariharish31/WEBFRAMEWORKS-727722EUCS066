...
import com.example.day5cw1.service.HarishProductService;
...
public class HarishProductController {
    ...
    public ResponseEntity<HarishProduct> putMethodName(@PathVariable("productId") int id, @RequestBody HarishProduct product) {
    ...
    public ResponseEntity<HarishProduct> delete(@PathVariable("productId") int id,@RequestBody HarishProduct product)
    {
